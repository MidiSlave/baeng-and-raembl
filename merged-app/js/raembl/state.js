...
export const parameterDefinitions = {
    ...
    // Factors
    'factors.steps': { statePath: 'steps', min: 1, max: 32, step: 1, module: 'raembl-factors', label: 'STEPS', modulatable: true },
    'factors.fills': { statePath: 'fills', min: 1, max: 32, step: 1, module: 'raembl-factors', label: 'FILLS', modulatable: true },
    'factors.shift': { statePath: 'rotation', min: 0, max: 31, step: 1, module: 'raembl-factors', label: 'SHIFT', modulatable: true },
    'factors.accentAmt': { statePath: 'accentAmt', min: 0, max: 16, module: 'raembl-factors', label: '>', step: 1, modulatable: true },
    'factors.slideAmt': { statePath: 'slideAmt', min: 0, max: 16, module: 'raembl-factors', label: 'SLIDE', step: 1, modulatable: true },
    'factors.trillAmt': { statePath: 'trillAmt', min: 0, max: 16, module: 'raembl-factors', label: 'TR', step: 1, modulatable: true },
    'factors.gateLength': { statePath: 'gateLength', min: 5, max: 100, module: 'raembl-factors', label: 'GATE', modulatable: true },
    // LFO (Main)
    'lfo.amp': { statePath: 'lfoAmp', min: 0, max: 100, module: 'raembl-lfo', label: 'AMP', modulatable: true },
    'lfo.freq': { statePath: 'lfoFreq', min: 0, max: 100, module: 'raembl-lfo', label: 'FREQ', modulatable: true },
    'lfo.waveform': { statePath: 'lfoWaveform', min: 0, max: 100, module: 'raembl-lfo', label: 'WAVE', modulatable: true },
    'lfo.offset': { statePath: 'lfoOffset', min: -100, max: 100, module: 'raembl-lfo', label: 'OFFSET', modulatable: true },
    // Path
    'path.scale': { statePath: 'scale', min: 0, max: 31, step: 1, module: 'raembl-path', label: 'SCALE', modulatable: true },
    'path.root': { statePath: 'root', min: 0, max: 11, step: 1, module: 'raembl-path', label: 'ROOT', modulatable: true },
    'path.probability': { statePath: 'probability', min: 0, max: 100, module: 'raembl-path', label: 'PROB', modulatable: true },
    // Reverb
